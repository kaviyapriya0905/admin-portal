                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-8">
                      <div className="space-y-2 group">
                        <label className="text-[9px] font-bold text-slate-400 uppercase tracking-wider group-focus-within:text-brand-primary transition-colors">First Name</label>
                        <input type="text" value={profileData.firstName} onChange={e => setProfileData(p => ({...p, firstName: e.target.value}))} className="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10 outline-none text-[12px] font-semibold text-slate-800 transition-all placeholder:text-slate-300 shadow-sm" />
                      </div>
                      <div className="space-y-2 group">
                        <label className="text-[9px] font-bold text-slate-400 uppercase tracking-wider group-focus-within:text-brand-primary transition-colors">Last Name</label>
                        <input type="text" value={profileData.lastName} onChange={e => setProfileData(p => ({...p, lastName: e.target.value}))} className="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10 outline-none text-[12px] font-semibold text-slate-800 transition-all placeholder:text-slate-300 shadow-sm" />
                      </div>
                      <div className="space-y-2 group">
                        <label className="text-[9px] font-bold text-slate-400 uppercase tracking-wider group-focus-within:text-brand-primary transition-colors">Email Address</label>
                        <input type="email" value={profileData.email} onChange={e => setProfileData(p => ({...p, email: e.target.value}))} className="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10 outline-none text-[12px] font-semibold text-slate-800 transition-all placeholder:text-slate-300 shadow-sm" />
                      </div>
                      <div className="space-y-2 group">
                        <label className="text-[9px] font-bold text-slate-400 uppercase tracking-wider group-focus-within:text-brand-primary transition-colors">Phone Number</label>
                        <input type="text" value={profileData.phone} onChange={e => setProfileData(p => ({...p, phone: e.target.value}))} className="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10 outline-none text-[12px] font-semibold text-slate-800 transition-all placeholder:text-slate-300 shadow-sm" />
                      </div>
                  ...
                  >
                    <div>
                      ...
                      <div className="space-y-6 max-w-xl">
                        <div className="space-y-2 group">
                          <label className="text-[9px] font-bold text-slate-400 uppercase tracking-wider group-focus-within:text-brand-primary transition-colors">Current Password</label>
                          <input type="password" placeholder="••••••••" value={securityData.currentPassword} onChange={e => setSecurityData(p => ({...p, currentPassword: e.target.value}))} className="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10 outline-none text-[12px] font-semibold text-slate-800 transition-all placeholder:text-slate-300 shadow-sm" />
                        </div>
                        <div className="space-y-2 group">
                          <label className="text-[9px] font-bold text-slate-400 uppercase tracking-wider group-focus-within:text-brand-primary transition-colors">New Password</label>
                          <input type="password" placeholder="••••••••" value={securityData.newPassword} onChange={e => setSecurityData(p => ({...p, newPassword: e.target.value}))} className="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10 outline-none text-[12px] font-semibold text-slate-800 transition-all placeholder:text-slate-300 shadow-sm" />
                        </div>
                        <div className="space-y-2 group">
                          <label className="text-[9px] font-bold text-slate-400 uppercase tracking-wider group-focus-within:text-brand-primary transition-colors">Confirm New Password</label>
                          <input type="password" placeholder="••••••••" value={securityData.confirmPassword} onChange={e => setSecurityData(p => ({...p, confirmPassword: e.target.value}))} className="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10 outline-none text-[12px] font-semibold text-slate-800 transition-all placeholder:text-slate-300 shadow-sm" />
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                         <div className="space-y-2 group">
                            <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider group-focus-within:text-brand-primary transition-colors">Interface Language</label>
                            <div className="relative">
                               <select value={preferencesData.language} onChange={e => setPreferencesData(p => ({...p, language: e.target.value}))} className="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10 outline-none text-[12px] font-semibold text-slate-800 transition-all appearance-none cursor-pointer shadow-sm">
                         ...
                         <div className="space-y-2 group">
                            <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider group-focus-within:text-brand-primary transition-colors">UI Theme</label>
                            <div className="relative">
                               <select value={preferencesData.theme} onChange={e => setPreferencesData(p => ({...p, theme: e.target.value}))} className="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10 outline-none text-[12px] font-semibold text-slate-800 transition-all appearance-none cursor-pointer shadow-sm">
