...
import { LiveDonationTicker } from "./components/LiveListWidgets";
...
const Donations: React.FC = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      // Simulate live incoming E-Hundi donation
      // const amount = Math.floor(Math.random() * 500) + 10;
      // // setLiveTicker(prev => [newTicker, ...prev].slice(0, 5));
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto relative">
            ...
            <div className="relative flex-1 sm:w-64 group">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-lg text-[13px] focus:outline-none focus:border-brand-primary/30 transition-all"
              />
            </div>
          </div>
        </div>
