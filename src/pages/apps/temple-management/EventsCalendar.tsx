...
import { UpcomingEventCountdown } from "./components/LiveListWidgets";
          ...
          <div className="bg-white/90 backdrop-blur-2xl rounded-3xl border border-white shadow-[0_8px_30px_rgb(0,0,0,0.06)] p-6 sm:p-8 flex flex-col h-[500px] xl:h-auto xl:min-h-[500px] overflow-hidden relative">
            ...
            <div className="relative mb-6 z-10">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3.5 bg-slate-50/80 border border-slate-200/60 rounded-xl text-sm font-medium focus:outline-none focus:ring-4 focus:ring-brand-primary/10 focus:border-brand-primary transition-all placeholder:text-slate-400 focus:bg-white"
              />
            </div>
