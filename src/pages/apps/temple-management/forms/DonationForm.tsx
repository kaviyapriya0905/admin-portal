            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="sm:col-span-2 relative">
                  ...
                  <p className="text-[10px] text-slate-400 mt-1.5 font-medium">Search by name or phone. Linked profiles ensure accurate historical tracking.</p>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="sm:col-span-2">
                  <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2 block flex items-center gap-1.5">
                    <StickyNote className="w-3 h-3" /> Audit Notes
                  </label>
                  <textarea
                    value={formData.notes}
                    onChange={e => setFormData(p => ({ ...p, notes: e.target.value }))}
                    placeholder="Audit notes, blessings, or references..."
                    rows={3}
