...
import {
  ...
  CloudLightning, Info, Link2, Users
} from "lucide-react";
                      ...
                      <div className="p-5 bg-slate-50 rounded-xl border border-slate-100">
                        ...
                        <div className="flex items-center gap-5">
                          <input
                            ...
                            onChange={e => setFormData(p => ({ ...p, totalDays: Number(e.target.value) || 2 }))}
                            className="h-11 w-24 rounded-xl border border-slate-200 bg-white text-center font-bold text-slate-900 outline-none focus:border-brand-primary/40 focus:ring-2 focus:ring-brand-primary/10"
                          />
                          <div>
