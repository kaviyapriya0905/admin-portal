            ...
            <div className="space-y-6">
              ...
              <div className="group/field">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 bg-slate-50 border border-slate-100 rounded-md text-[12px] focus:outline-none focus:ring-4 focus:ring-brand-primary/5 focus:border-brand-primary focus:bg-white transition-all font-medium text-slate-900 min-h-[80px] resize-none"
                />
              </div>

              <div className="group/field">
                <label className="block text-[11px] font-bold text-slate-400 normal-case tracking-normal mb-1.5 ml-1 group-focus-within/field:text-brand-primary transition-colors">
                  Unit overview & summary (Bio)
                </label>
                <textarea
                  value={formData.bio || ""}
              ...
              <div className="group/field">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 bg-slate-50 border border-slate-100 rounded-md text-[12px] focus:outline-none focus:ring-4 focus:ring-brand-primary/5 focus:border-brand-primary focus:bg-white transition-all font-medium text-slate-900 min-h-[120px] resize-none"
                ...
                <div className="pt-6 border-t border-slate-100 space-y-5">
                  ...
                  <div className="group/field">
                    ...
                    <textarea
                      ...
                      onChange={(e) => setFormData({ ...formData, superadmin: { ...formData.superadmin!, bio: e.target.value } })}
                      className="w-full px-4 py-2.5 bg-slate-50 border border-slate-100 rounded-md text-[12px] focus:outline-none focus:ring-4 focus:ring-brand-primary/5 focus:border-brand-primary focus:bg-white transition-all font-medium text-slate-900 min-h-[80px] resize-none"
                    />
                  </div>
                </div>
